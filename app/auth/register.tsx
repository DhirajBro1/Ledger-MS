        ...
        >
          ...
          <View style={[styles.heroCard, { backgroundColor: palette.card, borderColor: palette.border }]}> 
            <View style={[styles.badge, { backgroundColor: palette.cardAlt, borderColor: palette.border }]}>
              <Text style={[styles.badgeText, { color: palette.accentStrong }]}>Business setup</Text>
            </View>
            <Text style={[styles.title, { color: palette.text }]}>Create your account</Text>
            <Text style={[styles.subtitle, { color: palette.muted }]}>Set up Ledger for your shop or office and start tracking dues, receipts, and customer balances in one place.</Text>
          </View>

          <View style={[styles.formCard, { backgroundColor: palette.card, borderColor: palette.border }]}> 
            <Text style={[styles.sectionLabel, { color: palette.muted }]}>Workspace details</Text>
            ...
            <Text style={[styles.fieldLabel, { color: palette.text }]}>Confirm password</Text>
            <View style={styles.passwordFieldWrap}>
              <TextInput
                style={[
                  styles.input,
            ...
            <View style={styles.footer}>
              ...
              <Pressable onPress={() => router.push('/auth/login')} disabled={loading}>
                <Text style={[styles.link, { color: palette.accentStrong }]}>Sign in</Text>
              </Pressable>
            </View>
          </View>
        </ScrollView>
